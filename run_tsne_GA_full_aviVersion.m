...
for experimentCount = 1:10
    ...
    for trial = 6:6
        ...
        %% Financial Ratios
        if trial == 1
            local = 'D:\DropBox\Avi_and_the_Gang\Shy\large_files\financialratios.data.csv';
            name = 'financialratios';
        elseif trial == 2     
        %% Qualitative bankruptcy
            local = 'D:\DropBox\Avi_and_the_Gang\Shy\large_files\Qualitative_Bankruptcy.data.csv';
            name = 'QualitativeBankruptcy';
        elseif trial == 3  
        %% CMC Database
            local = 'D:\DropBox\Avi_and_the_Gang\Shy\large_files\CMC_DataBase.csv';
            tags = 'D:\DropBox\Avi_and_the_Gang\Shy\large_files\CMC_DataBase_labels.csv';
            name = 'CMC';
        elseif trial == 4  
        %% Bitter Database
            local = 'D:\DropBox\Avi_and_the_Gang\Shy\large_files\bitter_dataBase.csv';
            name = 'bitter';
        elseif trial == 5  
        %% Solar Cells Database
            local = 'D:\DropBox\Avi_and_the_Gang\Shy\large_files\solar_cells_DataBase.csv';
            name = 'solar_cells';
        elseif trial == 6  
        %% LogBBB Database
        ...
        elseif trial == 7  
        %% FeGaPd Database
            local = 'D:\DropBox\Avi_and_the_Gang\Shy\large_files\FeGaPd_Exp_PP.csv';
            name = 'FeGaPd';
        end
