...
for trial = 6:6
    ...
    %% Financial Ratios
    if trial == 1
        local = 'C:\Users\avi\Dropbox\Avi_and_the_Gang\Shy\t-SNEAvi_and_the_Gang\Shy\large_files\financialratios.data.csv';
    ...
    elseif trial == 3  
    %% CMC Database
        local = 'C:\Users\avi\Dropbox\Avi_and_the_Gang\Shy\large_files\CMC_DataBase.csv';
        tags = 'C:\Users\avi\Dropbox\Avi_and_the_Gang\Shy\large_files\CMC_DataBase_labels.csv';
        name = 'CMC';
    elseif trial == 4  
    %% Bitter Database
        local = 'C:\Users\avi\Dropbox\Avi_and_the_Gang\Shy\large_files\bitter_dataBase.csv';
        name = 'bitter';
    elseif trial == 5  
    %% Solar Cells Database
        local = 'C:\Users\avi\Dropbox\Avi_and_the_Gang\Shy\large_files\solar_cells_DataBase.csv';
        name = 'solar_cells';
    elseif trial == 6  
    %% LogBBB Database
    ...
    for generations = 1 : 128
        ...
        % if inter_q > top_q  % there was improvement or overcoming local maximum        
            try
                ...
                % view(40,35)
                csvwrite(sprintf('results_avinew/%s_population_%0.3f.csv',name, generations), population);
                filename = sprintf('results_avinew/%s_q_%0.3f_q3_%0.3f_q5_%0.3f_trust_%0.3f_number_%0.0f_features_%0.0f.png',name, top_q, top_q3, top_q5, top_trust, top_num, top_features);
                ...
                saveas(h1, filename);
                figfilename = sprintf('results_avinew/%s_q_%0.3f_q3_%0.3f_q5_%0.3f_trust_%0.3f_number_%0.0f_features_%0.0f.fig',name, top_q, top_q3, top_q5, top_trust, top_num, top_features);
                savefig(h1,figfilename);
                csvwrite(sprintf('results_avinew/%s_q_%0.3f_q3_%0.3f_q5_%0.3f_trust_%0.3f_number_%0.0f_features_%0.0f.csv',name,  top_q, top_q3, top_q5, top_trust, top_num, top_features), map);
            catch ME
